...
public class FindPortsMojo extends AbstractMojo {
    ...
    /**
     * Specifies the starting offset. If set to 0 then the first iteration uses the
     * port numbers as configured in {@link FindPortsMojo#ports}
     */
    ...
    /**
     * Iterates over the configured ports, adds an offset and checks if these ports
     * are available
     * 
     * @return
